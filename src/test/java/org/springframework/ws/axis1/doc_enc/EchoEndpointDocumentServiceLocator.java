...
public class EchoEndpointDocumentServiceLocator extends org.apache.axis.client.Service implements org.springframework.ws.axis1.doc_enc.EchoEndpointDocumentService {
    ...
    public java.lang.String getEchoEndpointDocumentEncodedAddress() {
        return EchoEndpointDocumentEncoded_address;
    }
    ...
    public java.lang.String getEchoEndpointDocumentEncodedWSDDServiceName() {
        return EchoEndpointDocumentEncodedWSDDServiceName;
    }

    public void setEchoEndpointDocumentEncodedWSDDServiceName(java.lang.String name) {
        EchoEndpointDocumentEncodedWSDDServiceName = name;
    }
    ...
    public org.springframework.ws.axis1.doc_enc.EchoEndpointDocument getEchoEndpointDocumentEncoded() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            endpoint = new java.net.URL(EchoEndpointDocumentEncoded_address);
        }
        catch (java.net.MalformedURLException e) {
            throw new javax.xml.rpc.ServiceException(e);
        }
        return getEchoEndpointDocumentEncoded(endpoint);
    }

    public org.springframework.ws.axis1.doc_enc.EchoEndpointDocument getEchoEndpointDocumentEncoded(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.springframework.ws.axis1.doc_enc.EchoEndpointDocumentEncodedSoapBindingStub _stub = new org.springframework.ws.axis1.doc_enc.EchoEndpointDocumentEncodedSoapBindingStub(portAddress, this);
            _stub.setPortName(getEchoEndpointDocumentEncodedWSDDServiceName());
            return _stub;
        }
    ...
    public void setEchoEndpointDocumentEncodedEndpointAddress(java.lang.String address) {
        EchoEndpointDocumentEncoded_address = address;
    }
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.springframework.ws.axis1.doc_enc.EchoEndpointDocument.class.isAssignableFrom(serviceEndpointInterface)) {
                org.springframework.ws.axis1.doc_enc.EchoEndpointDocumentEncodedSoapBindingStub _stub = new org.springframework.ws.axis1.doc_enc.EchoEndpointDocumentEncodedSoapBindingStub(new java.net.URL(EchoEndpointDocumentEncoded_address), this);
                _stub.setPortName(getEchoEndpointDocumentEncodedWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("EchoEndpointDocumentEncoded".equals(inputPortName)) {
            return getEchoEndpointDocumentEncoded();
        }
        else  {
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", "EchoEndpointDocumentEncoded"));
        }
...
if ("EchoEndpointDocumentEncoded".equals(portName)) {
            setEchoEndpointDocumentEncodedEndpointAddress(address);
        }
        else 
{ // Unknown Port Name
