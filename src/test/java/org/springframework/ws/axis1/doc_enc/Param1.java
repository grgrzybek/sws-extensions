...
public class Param1 implements java.io.Serializable {
	...
	private org.springframework.ws.axis1.doc_enc.Param2 param2 = new Param2();

	private org.springframework.ws.axis1.doc_enc.Param3[] param3List = new Param3[] { new Param3(), new Param3(), new Param3() };
	...
	public Param1(java.lang.Byte[] list, java.lang.Long number, org.springframework.ws.axis1.doc_enc.Param2 param2,
			org.springframework.ws.axis1.doc_enc.Param3[] param3List, java.lang.String string) {
		this.list = list;
		this.number = number;
		this.param2 = param2;
	 ...
	 * @return param2
	 */
	public org.springframework.ws.axis1.doc_enc.Param2 getParam2() {
		return this.param2;
	}
	 ...
	 * @param param2
	 */
	public void setParam2(org.springframework.ws.axis1.doc_enc.Param2 param2) {
		this.param2 = param2;
	}
	 ...
	 * @return param3List
	 */
	public org.springframework.ws.axis1.doc_enc.Param3[] getParam3List() {
	 ...
	 * @param param3List
	 */
	public void setParam3List(org.springframework.ws.axis1.doc_enc.Param3[] param3List) {
		this.param3List = param3List;
	}
