...
public class EchoEndpointDocumentServiceLocator extends org.apache.axis.client.Service implements org.springframework.ws.axis1.doc_lit.EchoEndpointDocumentService {
    ...
    public java.lang.String getEchoEndpointDocumentLiteralAddress() {
        return EchoEndpointDocumentLiteral_address;
    }
    ...
    public java.lang.String getEchoEndpointDocumentLiteralWSDDServiceName() {
        return EchoEndpointDocumentLiteralWSDDServiceName;
    }

    public void setEchoEndpointDocumentLiteralWSDDServiceName(java.lang.String name) {
        EchoEndpointDocumentLiteralWSDDServiceName = name;
    }
    ...
    public org.springframework.ws.axis1.doc_lit.EchoEndpointDocument getEchoEndpointDocumentLiteral() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            endpoint = new java.net.URL(EchoEndpointDocumentLiteral_address);
        }
        catch (java.net.MalformedURLException e) {
            throw new javax.xml.rpc.ServiceException(e);
        }
        return getEchoEndpointDocumentLiteral(endpoint);
    }
    ...
    public org.springframework.ws.axis1.doc_lit.EchoEndpointDocument getEchoEndpointDocumentLiteral(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.springframework.ws.axis1.doc_lit.EchoEndpointDocumentLiteralSoapBindingStub _stub = new org.springframework.ws.axis1.doc_lit.EchoEndpointDocumentLiteralSoapBindingStub(portAddress, this);
            _stub.setPortName(getEchoEndpointDocumentLiteralWSDDServiceName());
            return _stub;
        }
    ...
    public void setEchoEndpointDocumentLiteralEndpointAddress(java.lang.String address) {
        EchoEndpointDocumentLiteral_address = address;
    }
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.springframework.ws.axis1.doc_lit.EchoEndpointDocument.class.isAssignableFrom(serviceEndpointInterface)) {
                org.springframework.ws.axis1.doc_lit.EchoEndpointDocumentLiteralSoapBindingStub _stub = new org.springframework.ws.axis1.doc_lit.EchoEndpointDocumentLiteralSoapBindingStub(new java.net.URL(EchoEndpointDocumentLiteral_address), this);
                _stub.setPortName(getEchoEndpointDocumentLiteralWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("EchoEndpointDocumentLiteral".equals(inputPortName)) {
            return getEchoEndpointDocumentLiteral();
        }
        else  {
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", "EchoEndpointDocumentLiteral"));
        }
...
if ("EchoEndpointDocumentLiteral".equals(portName)) {
            setEchoEndpointDocumentLiteralEndpointAddress(address);
        }
        else 
{ // Unknown Port Name
