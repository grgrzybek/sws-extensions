...
public class EchoResponse  implements java.io.Serializable {
    private org.springframework.ws.axis1.case2.contractfirst.wrapped_encoded_11_arrayswrapped.Result1 echoReturn;

    public EchoResponse() {
    }

    public EchoResponse(
           org.springframework.ws.axis1.case2.contractfirst.wrapped_encoded_11_arrayswrapped.Result1 echoReturn) {
     ...
     * @return echoReturn
     */
    public org.springframework.ws.axis1.case2.contractfirst.wrapped_encoded_11_arrayswrapped.Result1 getEchoReturn() {
        return echoReturn;
    }
     ...
     * @param echoReturn
     */
    public void setEchoReturn(org.springframework.ws.axis1.case2.contractfirst.wrapped_encoded_11_arrayswrapped.Result1 echoReturn) {
        this.echoReturn = echoReturn;
    }
