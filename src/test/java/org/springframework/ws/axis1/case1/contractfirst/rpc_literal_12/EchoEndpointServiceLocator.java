...
public class EchoEndpointServiceLocator extends org.apache.axis.client.Service implements org.springframework.ws.axis1.case1.contractfirst.rpc_literal_12.EchoEndpointService {
    ...
    public org.springframework.ws.axis1.case1.contractfirst.rpc_literal_12.EchoEndpoint getEchoEndpointRpcLiteral12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.springframework.ws.axis1.case1.contractfirst.rpc_literal_12.EchoEndpointRpcLiteral12SoapBindingStub _stub = new org.springframework.ws.axis1.case1.contractfirst.rpc_literal_12.EchoEndpointRpcLiteral12SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.springframework.ws.axis1.case1.contractfirst.rpc_literal_12.EchoEndpoint.class.isAssignableFrom(serviceEndpointInterface)) {
                org.springframework.ws.axis1.case1.contractfirst.rpc_literal_12.EchoEndpointRpcLiteral12SoapBindingStub _stub = new org.springframework.ws.axis1.case1.contractfirst.rpc_literal_12.EchoEndpointRpcLiteral12SoapBindingStub(new java.net.URL(EchoEndpointRpcLiteral12_address), this);
                _stub.setPortName(getEchoEndpointRpcLiteral12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://codefirst.case1.axis1.ws.springframework.org", "EchoEndpointRpcLiteral12"));
        }
