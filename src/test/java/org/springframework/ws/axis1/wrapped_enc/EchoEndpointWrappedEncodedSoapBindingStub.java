/**
 * EchoEndpointWrappedEncodedSoapBindingStub.java
 *
...
public class EchoEndpointWrappedEncodedSoapBindingStub extends org.apache.axis.client.Stub implements
	...
	private static void _initOperationDesc1() {
		...
		oper.setName("wrappedEnc");
		param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", "wrappedEnc"),
				org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", ">wrappedEnc"),
				org.springframework.ws.axis1.wrapped_enc.WrappedEnc.class, false, false);
		oper.addParameter(param);
		oper.setReturnType(new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", ">wrappedEncResponse"));
		oper.setReturnClass(org.springframework.ws.axis1.wrapped_enc.WrappedEncResponse.class);
		oper.setReturnQName(new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", "wrappedEncResponse"));
	...
	public EchoEndpointWrappedEncodedSoapBindingStub() throws org.apache.axis.AxisFault {
		this(null);
	}

	public EchoEndpointWrappedEncodedSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public EchoEndpointWrappedEncodedSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		if (service == null) {
		...
		cls = org.springframework.ws.axis1.wrapped_enc.Param1.class;
		...
		this.cachedSerQNames.add(qName);
		cls = org.springframework.ws.axis1.wrapped_enc.Param2.class;
		this.cachedSerClasses.add(cls);
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);
		...
		this.cachedSerQNames.add(qName);
		cls = org.springframework.ws.axis1.wrapped_enc.Param3.class;
		this.cachedSerClasses.add(cls);
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);
		...
		this.cachedSerQNames.add(qName);
		cls = org.springframework.ws.axis1.wrapped_enc.Result1.class;
		this.cachedSerClasses.add(cls);
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);

		qName = new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", ">wrappedEnc");
		this.cachedSerQNames.add(qName);
		cls = org.springframework.ws.axis1.wrapped_enc.WrappedEnc.class;
		this.cachedSerClasses.add(cls);
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);

		qName = new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", ">wrappedEncResponse");
		this.cachedSerQNames.add(qName);
		cls = org.springframework.ws.axis1.wrapped_enc.WrappedEncResponse.class;
		this.cachedSerClasses.add(cls);
		this.cachedSerFactories.add(beansf);
		this.cachedDeserFactories.add(beandf);
	...
	public org.springframework.ws.axis1.wrapped_enc.WrappedEncResponse wrappedEnc(org.springframework.ws.axis1.wrapped_enc.WrappedEnc parameters)
		...
		_call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
		_call.setOperationName(new javax.xml.namespace.QName("", "wrappedEnc"));
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					return (org.springframework.ws.axis1.wrapped_enc.WrappedEncResponse) _resp;
				}
				catch (java.lang.Exception _exception) {
					return (org.springframework.ws.axis1.wrapped_enc.WrappedEncResponse) org.apache.axis.utils.JavaUtils.convert(_resp,
							org.springframework.ws.axis1.wrapped_enc.WrappedEncResponse.class);
				}
			}
		}
