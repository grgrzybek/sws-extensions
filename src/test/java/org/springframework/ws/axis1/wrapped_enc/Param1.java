...
public class Param1 implements java.io.Serializable {
	...
	private org.springframework.ws.axis1.wrapped_enc.Param3[] param3List = new Param3[] { new Param3(), new Param3(), new Param3() };
	...
	public Param1(java.lang.Byte[] list, java.lang.Long number, org.springframework.ws.axis1.wrapped_enc.Param2 param2,
			org.springframework.ws.axis1.wrapped_enc.Param3[] param3List, java.lang.String string) {
		this.list = list;
		this.number = number;
		this.param2 = param2;
	 ...
	 * @return param3List
	 */
	public org.springframework.ws.axis1.wrapped_enc.Param3[] getParam3List() {
	 ...
	 * @param param3List
	 */
	public void setParam3List(org.springframework.ws.axis1.wrapped_enc.Param3[] param3List) {
		this.param3List = param3List;
	}
