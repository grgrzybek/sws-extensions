...
public class Param1 implements java.io.Serializable {
	...
	private org.springframework.ws.axis1.wrapped_lit.Param3[] param3List = new Param3[] { new Param3(), new Param3(), new Param3() };
	...
	public Param1(byte[] list, java.lang.Long number, org.springframework.ws.axis1.wrapped_lit.Param2 param2,
			org.springframework.ws.axis1.wrapped_lit.Param3[] param3List, java.lang.String string) {
		this.list = list;
		this.number = number;
		this.param2 = param2;
	 ...
	 * @return param3List
	 */
	public org.springframework.ws.axis1.wrapped_lit.Param3[] getParam3List() {
	 ...
	 * @param param3List
	 */
	public void setParam3List(org.springframework.ws.axis1.wrapped_lit.Param3[] param3List) {
		this.param3List = param3List;
	}
