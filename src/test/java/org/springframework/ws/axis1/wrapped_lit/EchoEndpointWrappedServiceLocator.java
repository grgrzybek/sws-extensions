...
public class EchoEndpointWrappedServiceLocator extends org.apache.axis.client.Service implements
		org.springframework.ws.axis1.wrapped_lit.EchoEndpointWrappedService {
	...
	public java.lang.String getEchoEndpointWrappedLiteralAddress() {
		return this.EchoEndpointWrappedLiteral_address;
	}
	...
	public java.lang.String getEchoEndpointWrappedLiteralWSDDServiceName() {
		return this.EchoEndpointWrappedLiteralWSDDServiceName;
	}

	public void setEchoEndpointWrappedLiteralWSDDServiceName(java.lang.String name) {
		this.EchoEndpointWrappedLiteralWSDDServiceName = name;
	}
	...
	public org.springframework.ws.axis1.wrapped_lit.EchoEndpointWrapped getEchoEndpointWrappedLiteral() throws javax.xml.rpc.ServiceException {
		...
		try {
			endpoint = new java.net.URL(this.EchoEndpointWrappedLiteral_address);
		}
		catch (java.net.MalformedURLException e) {
			throw new javax.xml.rpc.ServiceException(e);
		}
		return this.getEchoEndpointWrappedLiteral(endpoint);
	}
	...
	public org.springframework.ws.axis1.wrapped_lit.EchoEndpointWrapped getEchoEndpointWrappedLiteral(java.net.URL portAddress)
		...
		try {
			org.springframework.ws.axis1.wrapped_lit.EchoEndpointWrappedLiteralSoapBindingStub _stub = new org.springframework.ws.axis1.wrapped_lit.EchoEndpointWrappedLiteralSoapBindingStub(
					portAddress, this);
			_stub.setPortName(this.getEchoEndpointWrappedLiteralWSDDServiceName());
			return _stub;
		}
	...
	public void setEchoEndpointWrappedLiteralEndpointAddress(java.lang.String address) {
		this.EchoEndpointWrappedLiteral_address = address;
	}
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (org.springframework.ws.axis1.wrapped_lit.EchoEndpointWrapped.class.isAssignableFrom(serviceEndpointInterface)) {
				org.springframework.ws.axis1.wrapped_lit.EchoEndpointWrappedLiteralSoapBindingStub _stub = new org.springframework.ws.axis1.wrapped_lit.EchoEndpointWrappedLiteralSoapBindingStub(
						new java.net.URL(this.EchoEndpointWrappedLiteral_address), this);
				_stub.setPortName(this.getEchoEndpointWrappedLiteralWSDDServiceName());
				return _stub;
			}
		}
	...
	public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		...
		if ("EchoEndpointWrappedLiteral".equals(inputPortName)) {
			return this.getEchoEndpointWrappedLiteral();
		}
		else {
	...
	public java.util.Iterator getPorts() {
		if (this.ports == null) {
			...
			this.ports.add(new javax.xml.namespace.QName("http://dispatch2.axis1.ws.springframework.org/", "EchoEndpointWrappedLiteral"));
		}
	...
	*/
	public void setEndpointAddress(java.lang.String portName, java.lang.String address) throws javax.xml.rpc.ServiceException {
		...
		if ("EchoEndpointWrappedLiteral".equals(portName)) {
			this.setEchoEndpointWrappedLiteralEndpointAddress(address);
		}
