...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:d="http://docbook.org/ns/docbook">
	...
	<!-- see: http://docbkx-tools.sourceforge.net/advanced.html -->
	...
	<xsl:template name="user.header.navigation">
		<div style="background-image: url('images/header-bg.png'); background-repeat: repeat-x; height: 50px; line-height: 50px; margin: -1px;">
			<img src="images/header-text.png" height="47" width="220" />
		</div>
	</xsl:template>

	<xsl:template name="user.footer.navigation">
		<div style="background-image: url('images/footer-bg.png'); background-repeat: repeat-x; height: 5px; margin: -1px;"></div>
	</xsl:template>

	<xsl:template name="header.navigation" />

	<!-- see: html/chunk-common.xsl -->
