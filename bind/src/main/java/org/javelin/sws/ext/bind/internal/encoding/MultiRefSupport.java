...
public interface MultiRefSupport {
	...
	/**
	 * <p>MultiRef encoding doesn't marshal any property of complex type as attributes or characters - {@link ComplexTypePattern}
	 * uses this method to convert {@link SimpleTypePattern} to {@link ElementPattern}.</p>
	 * 
