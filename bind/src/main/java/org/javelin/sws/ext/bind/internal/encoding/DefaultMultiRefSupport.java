...
package org.javelin.sws.ext.bind.internal.encoding;
...
import org.javelin.sws.ext.bind.internal.model.SimpleTypePattern;
...
public class DefaultMultiRefSupport implements MultiRefSupport {
	...
	/* (non-Javadoc)
	 * @see org.javelin.sws.ext.bind.internal.encoding.MultiRefSupport#registerMultiRef(java.lang.Object, javax.xml.stream.XMLEventWriter, org.javelin.sws.ext.bind.internal.model.XmlEventsPattern)
	 */
	@Override
	public void registerMultiRef(Object object, XMLEventWriter eventWriter, TypedPattern<?> nestedPattern) throws XMLStreamException {
	...
	/* (non-Javadoc)
	 * @see org.javelin.sws.ext.bind.internal.encoding.MultiRefSupport#outputMultiRefs(javax.xml.stream.XMLEventWriter, org.javelin.sws.ext.bind.internal.MarshallingContext)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.javelin.sws.ext.bind.internal.encoding.MultiRefSupport#adaptPattern(org.javelin.sws.ext.bind.internal.model.XmlEventsPattern, java.lang.String)
	 */
	@Override
	public XmlEventsPattern adaptPattern(XmlEventsPattern pattern, String accessorName) {
		if (pattern instanceof SimpleTypePattern) {
			return ElementPattern.newElementPattern(new QName("", accessorName), (TypedPattern<?>) pattern);
		}
		else {
			return pattern;
		}
