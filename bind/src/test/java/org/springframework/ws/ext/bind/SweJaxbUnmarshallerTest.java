...
public class SweJaxbUnmarshallerTest {
	...
	public void unmarshalVeryComplexContentExplicitRI() throws Exception {
		...
		InputStream inputStream = new ClassPathResource("very-complex-content-01.xml", this.getClass()).getInputStream();
		// will throw javax.xml.bind.UnmarshalException: unexpected element (uri:"urn:test", local:"root"). Expected elements are <{y}x"
		JAXBElement<org.springframework.ws.ext.bind.jaxb.context6.ClassWithVeryComplexContent> je = um.unmarshal(XMLInputFactory.newFactory()
				.createXMLEventReader(inputStream), org.springframework.ws.ext.bind.jaxb.context6.ClassWithVeryComplexContent.class);
		org.springframework.ws.ext.bind.jaxb.context6.ClassWithVeryComplexContent ob = je.getValue();
