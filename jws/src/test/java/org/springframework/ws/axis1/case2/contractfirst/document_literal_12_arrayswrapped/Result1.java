...
public class Result1  implements java.io.Serializable {
   private ArrayOf_xsd_decimal list = new ArrayOf_xsd_decimal(new BigDecimal[] { new BigDecimal("890.123123"), new BigDecimal("0.12") });
    ...
    public Result1(
           org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arrayswrapped.ArrayOf_xsd_decimal list,
     ...
     * @return list
     */
    public org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arrayswrapped.ArrayOf_xsd_decimal getList() {
        return list;
    }
     ...
     * @param list
     */
    public void setList(org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arrayswrapped.ArrayOf_xsd_decimal list) {
        this.list = list;
    }
