...
public class EchoEndpointServiceLocator extends org.apache.axis.client.Service implements org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arraysplain.EchoEndpointService {
    ...
    public org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arraysplain.EchoEndpoint getEchoEndpointDocumentLiteral12() throws javax.xml.rpc.ServiceException {
    ...
    public org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arraysplain.EchoEndpoint getEchoEndpointDocumentLiteral12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arraysplain.EchoEndpointDocumentLiteral12SoapBindingStub _stub = new org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arraysplain.EchoEndpointDocumentLiteral12SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arraysplain.EchoEndpoint.class.isAssignableFrom(serviceEndpointInterface)) {
                org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arraysplain.EchoEndpointDocumentLiteral12SoapBindingStub _stub = new org.springframework.ws.axis1.case2.contractfirst.document_literal_12_arraysplain.EchoEndpointDocumentLiteral12SoapBindingStub(new java.net.URL(EchoEndpointDocumentLiteral12_address), this);
                _stub.setPortName(getEchoEndpointDocumentLiteral12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://codefirst.case2.axis1.ws.springframework.org", "EchoEndpointDocumentLiteral12"));
        }
